...
const VALUES = [
  {
    ...
    title: '진심 어린 돌봄',
    desc: '어르신을 가족처럼 대하며, 진심을 담은 돌봄 서비스를 제공합니다.',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    ...
    title: '신뢰와 전문성',
    desc: '체계적인 교육과 관리를 통해 전문적이고 신뢰할 수 있는 서비스를 보장합니다.',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    ...
    title: '소통과 협력',
    desc: '보호자와의 긴밀한 소통으로 어르신에게 최적의 돌봄 환경을 만듭니다.',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    ...
    title: '빠른 대응',
    desc: '긴급 상황 발생 시 즉각 대응하여 어르신의 안전을 최우선으로 합니다.',
  },
]
