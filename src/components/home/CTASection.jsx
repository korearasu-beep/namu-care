      ...
      <div className="mx-auto max-w-[700px] text-center relative z-[1]">
        <FadeIn>
          ...
          <div className="flex flex-col items-center gap-4">
            <a
              href={`tel:${phone}`}
              className="inline-flex items-center gap-2.5 bg-white text-deep-green rounded-2xl px-10 py-[18px] text-xl font-extrabold shadow-[0_4px_24px_rgba(0,0,0,0.2)] hover:bg-mint-pale transition-colors"
            >
